...
export const AboutInfo = () => {
  return (
    <div className="bg-[#1a1a1a] border-2 border-[#333] rounded-3xl p-8">
      <h3 className="text-4xl mb-6 text-[#f0d784]">Junior Game Designer</h3>
      <div className="space-y-4  text-lg text-[#f2f2f2] leading-relaxed">
        ...
        <p>
          ...
          , board games, tabletop RPG, and virtual reality; and seek new
          experiences by participating in game jams and realizing side projects
          during my free time.
        </p>
